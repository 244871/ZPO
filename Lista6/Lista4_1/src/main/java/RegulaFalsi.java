...
public class RegulaFalsi {
    ...
    public ArrayList<Wyniki2> wyniki = new ArrayList<>();
    ...
    void solver(double xl, double xu, double dok, int maxIter){
        ...
        for (int i = 0; i <maxIter; i++) {
            ...
            wyniki.add(new Wyniki2(i+1, xu, oblicz(xu), dokladnosc(xl, xu), xr(xl, xu), oblicz(xr(xl, xu)), bladT(xr(xl, xu)), bladA(xr(xl, xu),xstare )));
